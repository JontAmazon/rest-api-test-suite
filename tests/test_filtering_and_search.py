...
def test_filter_posts_by_user(posts_client, users_client, auth_headers):
    ...
    list_by_user = posts_client.list_posts(params={"user_id": user["id"]}, headers=auth_headers)
...
def test_filter_todos_by_user_and_due_on(todos_client, users_client, auth_headers):
    ...
    list_by_filter = todos_client.list_todos(params={"user_id": user["id"], "due_on": due_on_value}, headers=auth_headers)
